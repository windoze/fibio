...
namespace fibio { namespace fibers {
    ...
    class condition_error : public boost::system::system_error
    {
    public:
        condition_error() :
        boost::system::system_error(boost::system::error_code( 0, boost::system::system_category() ), "Condition error")
        {}
        
        condition_error( int ev) :
        boost::system::system_error(boost::system::error_code( ev, boost::system::system_category() ), "Condition error")
        {}
