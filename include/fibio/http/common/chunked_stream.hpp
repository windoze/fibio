//
// Created by Chen Xu on 15/8/30.
//

#ifndef FIBIO_CHUNKED_STREAM_HPP_H
#define FIBIO_CHUNKED_STREAM_HPP_H
...
namespace fibio { namespace http { namespace common {
    ...
    public:
        ...
        { sb_.raw_stream_=s; }
    private:
        chunked_streambuf sb_;
    };
}}}

#endif //FIBIO_CHUNKED_STREAM_HPP_H
