...
namespace fibio { namespace io {
    ...
    struct fiberized<boost::asio::basic_datagram_socket<Protocol, StreamSocketService>> : public boost::asio::basic_datagram_socket<Protocol, StreamSocketService>
    {
        typedef boost::asio::basic_datagram_socket<Protocol, StreamSocketService> base_type;
