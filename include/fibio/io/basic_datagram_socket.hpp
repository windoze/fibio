...
namespace fibio { namespace io {
    ...
    struct fiberized<asio::basic_datagram_socket<Protocol, StreamSocketService>> : public asio::basic_datagram_socket<Protocol, StreamSocketService>
    {
        typedef asio::basic_datagram_socket<Protocol, StreamSocketService> base_type;
